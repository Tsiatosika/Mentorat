...
import { Bell, BellDot, X, Check, MessageCircle, Calendar, FileText, UserPlus, Clock, ChevronRight } from 'lucide-react';
...
export function NotificationBell({ collapsed = false }: { collapsed?: boolean }) {
  ...
  // Affichage du bouton (toujours visible)
  const buttonContent = (
    <button
      ...
      <div className="max-h-96 overflow-y-auto">
        {loading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-400 dark:text-gray-500 text-xs mt-1">Les notifications apparaîtront ici</p>
          </div>
        ) : (
