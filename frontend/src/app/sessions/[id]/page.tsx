          ...
          <div className="p-6" style={{ backgroundColor: 'var(--bg-secondary)', borderBottom: '1px solid var(--border)' }}>
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="mt-1" style={{ color: 'var(--text-secondary)' }}>Session de mentorat</p>
              </div>
          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>Date de début</p>
                  <p className="font-mono-data font-medium" style={{ color: 'var(--text-primary)' }}>
              ...
              <div className="flex items-center gap-3">
                <Calendar className="w-5 h-5" style={{ color: 'var(--accent)' }} />
                <div>
                  <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>Date de fin</p>
                  <p className="font-mono-data font-medium" style={{ color: 'var(--text-primary)' }}>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>Mentor</p>
              ...
              <div className="flex items-center gap-3">
                <User className="w-5 h-5" style={{ color: 'var(--accent)' }} />
                <div>
                  <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>Mentoré</p>
                  <p className="font-medium" style={{ color: 'var(--text-primary)' }}>
            ...
            {session.description && (
              <div>
                ...
                <p className="rounded-lg p-4" style={{ backgroundColor: 'var(--bg-secondary)', color: 'var(--text-secondary)' }}>
                  {session.description}
                </p>
              </div>
            )}
            ...
            {session.lien_visio && (
              <div>
                <h3 className="text-sm font-medium mb-2" style={{ color: 'var(--text-secondary)' }}>Lien visioconférence</h3>
